package com.minagri.stats.vaadin.component.textfield.entity;
...
/**
 * This is a copy of the package protected class SimpleResult of Vaadin.
 *
 * @param <R>
 */
public class SimpleResult<R> implements Result<R> {
	 ...
	 */
	public SimpleResult(R value, String message) {
